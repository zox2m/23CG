...
public class musicsheet_hint : MonoBehaviour
    {
        public GameObject musicsheetHintUI; // 새 힌트 UI
        public GameObject player;
        public Camera camera;
        
        public void Start(){
            musicsheetHintUI.SetActive(false);
        }
        
        public void OnMouseDown() {
            if (ObjectClicker.uiIsActived == false) {
                Debug.Log("click Painting");
                musicsheetHintUI.SetActive(true); // 힌트 UI 활성화
        ...
        public void ClosmusicsheetHint() {
            Debug.Log("close painting hint ui");
            musicsheetHintUI.SetActive(false); // 힌트 UI 비활성화
